...
class BaseIngestor {
    ...
    async uploadToR2(key, data, contentType = 'application/json', bucketName) {
        try {
    ...
    async run(source, sourceHash, feedUrl, clientBucketName) {
        ...
        return this.process(source, sourceHash, feedUrl, clientBucketName);
    }
}
